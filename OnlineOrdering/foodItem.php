...
<body>
    ...
    <main class="page registration-page">
        <section class="clean-block clean-form dark"><div class="container">
    <div class="block-heading">
        <h2 class="text-info">Food Item</h2>
    </div>
				...
				<table id="user_data" class="table table-bordered table-striped">
					<thead>
						<tr>
                            ...
                            <th width="10%">Prepared Time</th>
                            <th width="5%">Dishes</th>
                            <th width="10%">Menu</th>
							<th width="5%">Edit</th>
		...
		<form method="post" id="user_form" enctype="multipart/form-data">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="text" name="fooditem_name" id="fooditem_name" class="form-control" />
					<br />
					<label>Price</label>
					...
					<input type="text" name="prepared_Time" id="prepared_Time" class="form-control" />
					<br /> 
                    <label>Dishes</label>
					<input type="text" name="dishes" id="dishes" class="form-control" />
					<br />
                    <label>Menu</label>
...
$(document).ready(function(){
	...
	$(document).on('submit', '#user_form', function(event){
		...
		var fooditem_name = $('#fooditem_name').val();
		var price = $('#price').val();
	...
	$(document).on('click', '.update', function(){
		...
		$.ajax({
			...
			success:function(data)
			{
				...
				$('#fooditem_name').val(data.fooditem_name);
				$('#price').val(data.price);
				$('#description').val(data.description);
				$('#prepared_Time').val(data.prepared_Time);
				$('#dishes').val(data.dishes);
				$('#menu').val(data.menu);
